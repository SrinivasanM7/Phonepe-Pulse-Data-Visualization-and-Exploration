...
def payment_amount_year(sel_year):
    ...
    fig_apay= px.bar(apay3, x="Transaction_type", y= "Transaction_amount", title= "PAYMENT AMOUNT and PAYMENT TYPE",
...
with tab1:
    ...
    with col2:
        st.video("C:\\Users\\ELCOT\\Desktop\\Data Science\\New folder\\phonepe\\Phone Pe Ad.mp4")

    col3,col4= st.columns(2)
    
    with col3:
        st.video("C:\\Users\\ELCOT\\Desktop\\Data Science\\New folder\\phonepe\\Phonepe motion graphics.mp4")
    ...
    with col6:
        st.video("C:\\Users\\ELCOT\\Desktop\\Data Science\\New folder\\phonepe\\Phonepe motion graphics 2.mp4")
